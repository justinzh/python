...
class ListTree:
    """
    Min-in that returens an __str__ trace of the entire class tree and all
    ...
    recursives to superclasses explicitly, uses str.format() for clarity;
    """
    __visited = {}
    ...
    def __str__(self):
        ...
        return '<Instance of {0}({1}), address {2}:\n{3}{4}>'.format(
            ...
            ','.join(sc.__name__ for sc in self.__class__.__bases__),
            id(self),
            here,
            above)
